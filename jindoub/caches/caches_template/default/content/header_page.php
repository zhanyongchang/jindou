...
<title><?php if(isset($SEO['title']) && !empty($SEO['title'])) { ?><?php echo $SEO['title'];?><?php } ?><?php echo 小金豆;?></title>
...
<div id="header">
	<div class="content">
	<div class="logo"><img src="<?php echo IMG_PATH;?>logo/logo2.png" height="60" /></div>
