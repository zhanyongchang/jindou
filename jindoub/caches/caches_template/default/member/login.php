...
<div id="header">
	<div class="content">
	<div class="logo"><a href="<?php echo $siteinfo['domain'];?>"><img src="<?php echo IMG_PATH;?>logo/logo2.png" /></a></div>
...
<input type="hidden" name="forward" id="forward" value="<?php echo $forward;?>">
        ...
        <div class="reg"><?php echo L('no_phpcms_account');?><br />
        	<div class="submit"><input type="button" name="register" value="<?php echo L('immediately').L('register');?>" onclick="redirect('<?php echo APP_PATH;?>index.php?m=member&c=index&a=register&siteid=<?php echo $siteid;?>')"></div>
        </div>
</form>
</div>
    <div class="col-auto">
