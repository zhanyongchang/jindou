<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?>	<div class="col-left col-1 left-memu">
            ...
            <ul>
				...
				<li<?php if(ROUTE_A=="account_manage_password") { ?> class="on"<?php } ?>><a href="index.php?m=member&c=index&a=account_manage_password&t=1"><img src="<?php echo IMG_PATH;?>icon/icon_key.gif" width="16" height="16" /> <?php echo L('modify').L('password');?></a></li>
                ...
                <li<?php if(ROUTE_A=="account_change_email") { ?> class="on"<?php } ?>><a href="index.php?m=member&c=index&a=account_manage_email&t=1"><img src="<?php echo IMG_PATH;?>icon/vcard.png" /> <?php echo L('modify').L('email');?>/微信名</a></li>
            </ul>
