...
<div class="col-auto">
	<div class="col-1 ">
		...
		<div class="content">
			...
			<div class="col-auto">
				<h5><?php if($memberinfo['vip']) { ?><img src="<?php echo IMG_PATH;?>icon/vip.gif"><?php } else { ?><img src="<?php echo IMG_PATH;?>icon/vip-expired.gif" title="<?php echo L('overdue');?>，<?php echo L('overduedate');?>：<?php echo format::date($memberinfo['overduedate'],1);?>"><?php } ?>
				...
				<p class="blue">
				<?php echo L('member_group');?>：
				<?php if($grouplist[$memberinfo['groupid']]['name'] != "vip0") { ?>
				<span style="color: #ff860f;font-size: 14px;"><?php echo $grouplist[$memberinfo['groupid']]['name'];?></span>，
				<?php } elseif ($grouplist[$memberinfo['groupid']]['name'] == "vip0") { ?>
				<span style="color: #000;font-size: 14px;"><?php echo $grouplist[$memberinfo['groupid']]['name'];?></span>，
				<?php } ?>
				...
				<?php echo L('point');?>：<font style="color:#F00; font-size:12px;font-family:Georgia,Arial; font-weight:700"><?php echo $memberinfo['point'];?></font> <?php echo L('unit_point');?>
				<?php if($memberinfo['vip']) { ?>，
				vip<?php echo L('overduedate');?>：
				<font style="color:#F00; font-size:12px;font-family:Georgia,Arial; font-weight:700"><?php echo date('Y-m-d H:i',$memberinfo['overduedate']);?></font>
				<?php } ?>
				</p>
			</div>
		</div>
	...
	<div class="col-1 ">
		...
		<div class="content">
				<table width="100%" cellspacing="0" class="table_form">
					...
					<tr>
						<th width="120"><?php echo L('member_group');?>：</th>        
						<td>
						<?php if($grouplist[$memberinfo['groupid']]['name'] != "vip0") { ?>
						<span style="color: #ff860f;font-size: 14px;"><?php echo $grouplist[$memberinfo['groupid']]['name'];?></span>
						<?php } elseif ($grouplist[$memberinfo['groupid']]['name'] == "vip0") { ?>
						<span><?php echo $grouplist[$memberinfo['groupid']]['name'];?></span>
						<?php } ?>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="color:#ff6600;"><strong><?php if($memberinfo['mobile']) { ?><?php echo substr($memberinfo['mobile'],0,3);?>****<?php echo substr($memberinfo['mobile'],-4);?><?php } ?></strong> 
