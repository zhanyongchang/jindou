...
<h6 class="title"><?php echo L('financial_management');?></h6>
        ...
        <?php if(module_exists('order')) { ?>
          <li<?php if(ROUTE_M=="order" && ROUTE_C=="cart") { ?> class="on"<?php } ?>><a href="index.php?m=order&c=cart&a=init"><img src="<?php echo IMG_PATH;?>icon/shoppingcart.gif" width="16" height="16" /> <?php echo L('cart');?></a></li>
          <li<?php if(ROUTE_M=="pay" && ROUTE_C=="order") { ?> class="on"<?php } ?>><a href="index.php?m=pay&c=order&a=init"><img src="<?php echo IMG_PATH;?>icon/m_8.png" width="16" height="16" /> <?php echo L('order');?></a></li>
        <?php } ?>
            <li<?php if(ROUTE_M=="member" && ROUTE_C=="index" && ROUTE_A=="log") { ?> class="on"<?php } ?>><a href="index.php?m=member&c=index&a=log"><img src="<?php echo IMG_PATH;?>icon/m_4.png" width="15" height="16" /> 奖励记录</a></li>
      </ul>
      <?php } ?>
      <!-- http://jindou.basiclink.cn:8080/phpcms/templates/default/member/log.html -->
<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"message\" data=\"op=message&tag_md5=6148979e8152595f69c4eb2d2a5ebab7&action=check_new\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}?>
<?php $new_arr = $data;?>
