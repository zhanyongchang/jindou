        	...
        	<div class="col-1 member-info">
            	<div class="content">
                  ...
                  <div class="col-auto">
                    ...
                    (<?php echo substr($memberinfo['mobile'],0,3);?>****<?php echo substr($memberinfo['mobile'],-4);?>)
					</h5>
                    <p class="blue">
					...
					<?php echo L('point');?>：<font style="color:#F00; font-size:12px;font-family:Georgia,Arial; font-weight:700"><?php echo $memberinfo['point'];?></font><img src="<?php echo IMG_PATH;?>l_logo/egg.gif"> 
