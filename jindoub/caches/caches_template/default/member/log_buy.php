        ...
        <div class="content">
            <div class="top_u">
                <ul id="hear">
                    ...
                    <li style="border-bottom: 2px solid #3aaafe;"><a href="index.php?m=member&c=index&a=log_buy">购物返利奖励记录</a></li>
                    <li><a href="index.php?m=member&c=index&a=log_tui">推广奖励记录</a></li>
                    <li><a href="index.php?m=member&c=index&a=log_ba">争霸奖励记录</a></li>
                </ul>
            </div>
            <div class="box_u">
                <ul id="contentop">
